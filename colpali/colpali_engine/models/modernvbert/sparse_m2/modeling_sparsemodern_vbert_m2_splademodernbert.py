...
# from transformers import AutoModelForMaskedLM # TODO check if maybe this way works better
...
class SparseModernVBertM2SpladeModernBERT(ModernVBertPreTrainedModel):
    ...
    def __init__(self, config, mask_non_image_embeddings: bool = False, **kwargs):
        ...
        # self.text_encoder = AutoModelForMaskedLM.from_pretrained("sparse-encoder/splade-ModernBERT-nq-fresh-lq0.05-lc0.003_scale1_lr-1e-4_bs64") # TODO check if maybe this way works better
